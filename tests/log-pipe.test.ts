...
test("log-pipe formats docker-compose prefixed lines from stdin", { timeout: 15_000 }, async () => {
  const input =
...
test("log-pipe --stream stderr forces ERROR level", { timeout: 15_000 }, async () => {
