...
Both affected crates passed locked compilation checks. Full-package rebuild and
live data/resource comparisons with this correction are still pending. Previous
