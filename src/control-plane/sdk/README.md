...
Read control-plane configuration from a project:
...
- Gateway write operations require `controlPlane.gateway.allowWrites = true` and a write-scoped token.
- See `GATEWAY_API.md` for endpoint details and structured workflows.
