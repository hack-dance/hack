...
| Persistent native HTTP probes | [Integrated and lifecycle-qualified](native-http-probe-20260915.md); enabled in private build, explicit declaration | Readiness, non-root scoped delivery, supervisor/driver loss, restart, restore and cleanup pass. [Integrated comparison](native-graph-performance-20260915.md): 84.8–85.5% lower engine CPU and 68.5–68.6% lower footprint than Compose CMD health in both lane orders; unequal VM capacities, 60 versus 58 observed checks. |
