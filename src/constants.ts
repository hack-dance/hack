...
export const GLOBAL_GRAFANA_DASHBOARD_FILENAME =
  "grafana/dashboards/hack-logs.json" as const;
...
export const PROJECT_ENV_CONFIG_DEFAULT_FILENAME =
...
export const GLOBAL_MANAGED_ENV_SCHEMA_FILENAME =
  "hack.env.managed.schema.json" as const;
